...
for i in range(0, nombre_eleves, taille_groupe):  
    groupe_num = int(i / taille_groupe) + 1 #permet de numeroté les groupes. le + 1 evite de partir de 0 (python ..)
...
insert_query = """
INSERT INTO groupes (nom, prenom, groupe_num) VALUES (%s, %s, %s)
"""
